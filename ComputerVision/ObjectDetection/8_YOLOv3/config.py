...
LOG_DIR = os.path.join(PROJECT_DIR, "logs", "coco2017", "YOLOv3")
CHECKPOINT_PATH = os.path.join(LOG_DIR, "yolov3.weights.h5")
...
CLASSIFIER_LOG_DIR = os.path.join(PROJECT_DIR, "logs", "imagenet", "YOLOv3")
