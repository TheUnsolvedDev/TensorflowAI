...
INPUT_SIZE = (256, 256)
GRID_SIZE = 8
# Original 416-pixel anchors scaled to the 256-pixel / 8x8 output contract.
ANCHORS = [(0.35245, 0.41685), (1.15351, 1.26925), (2.05442, 3.36882), (4.85097, 2.17094), (6.01279, 5.64202)]
...
LOG_DIR = os.path.join(PROJECT_DIR, "logs", "coco2017", "YOLOv2")
CHECKPOINT_PATH = os.path.join(LOG_DIR, "yolov2.weights.h5")
...
CLASSIFIER_LOG_DIR = os.path.join(PROJECT_DIR, "logs", "imagenet", "YOLOv2")
