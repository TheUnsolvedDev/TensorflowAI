...
- [x] **2017** – Mask R-CNN (Instance segmentation on top of Faster R-CNN)  
## Real-Time Object Detectors (YOLO & SSD)
- [x] **2016** – YOLOv1 (First real-time single-shot object detector)  
- [x] **2016** – SSD (Single Shot MultiBox Detector – SSD300, SSD512)  
- [x] **2017** – YOLOv2 ("YOLO9000" – better accuracy and speed)  
- [x] **2018** – YOLOv3 (Multi-scale detection, Darknet-53 backbone)  
