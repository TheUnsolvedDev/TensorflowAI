...
INPUT_SIZE = (256, 256)
FEATURE_MAP_SIZES = [16, 8, 4]
PRIOR_SCALES = [0.12, 0.24, 0.48]
...
LOG_DIR = os.path.join(PROJECT_DIR, "logs", "coco2017", "SSD")
CHECKPOINT_PATH = os.path.join(LOG_DIR, "ssd.weights.h5")
...
CLASSIFIER_LOG_DIR = os.path.join(PROJECT_DIR, "logs", "imagenet", "SSD")
