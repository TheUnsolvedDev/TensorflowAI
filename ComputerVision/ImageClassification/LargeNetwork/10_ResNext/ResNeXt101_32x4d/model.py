"""ResNeXt101_32x4d. TensorFlow implementation; no pretrained weights."""
...
def resnext101_32x4d_model(input_shape=tuple(INPUT_SIZE), num_classes=10):
    ...
    return tf.keras.Model(inputs, outputs, name='resnext101_32x4d_model')
