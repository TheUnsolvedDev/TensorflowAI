"""ViT_Base16; train from scratch. Patch projection and class-token pooling."""
...
def vit_base16_model(input_shape=tuple(INPUT_SIZE), num_classes=10):
    patch, dim, depth, heads = 16, 768, 12, 12
    ...
    return tf.keras.Model(inputs, outputs, name='vit_base16_model')
