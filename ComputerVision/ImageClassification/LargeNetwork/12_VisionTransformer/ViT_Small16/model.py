"""ViT_Small16; train from scratch. Patch projection and class-token pooling."""
...
def vit_small16_model(input_shape=tuple(INPUT_SIZE), num_classes=10):
    patch, dim, depth, heads = 16, 384, 12, 6
    ...
    return tf.keras.Model(inputs, outputs, name='vit_small16_model')
