"""ViT_Large16; train from scratch. Patch projection and class-token pooling."""
...
def vit_large16_model(input_shape=tuple(INPUT_SIZE), num_classes=10):
    patch, dim, depth, heads = 16, 1024, 24, 16
    ...
    return tf.keras.Model(inputs, outputs, name='vit_large16_model')
