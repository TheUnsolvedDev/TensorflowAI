"""SE_ResNet101. TensorFlow implementation; no pretrained weights."""
...
def se_resnet101_model(input_shape=tuple(INPUT_SIZE), num_classes=10):
    ...
    return tf.keras.Model(inputs, outputs, name='se_resnet101_model')
