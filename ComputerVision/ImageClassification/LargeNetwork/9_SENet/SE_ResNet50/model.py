"""SE_ResNet50. TensorFlow implementation; no pretrained weights."""
...
def se_resnet50_model(input_shape=tuple(INPUT_SIZE), num_classes=10):
    ...
    return tf.keras.Model(inputs, outputs, name='se_resnet50_model')
