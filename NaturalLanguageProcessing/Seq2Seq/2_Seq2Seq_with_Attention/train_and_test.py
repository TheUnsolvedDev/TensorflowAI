...
def get_log_dir(dataset_name):
    ...
    return os.path.join(LOG_DIR, dataset_name, "Seq2Seq", timestamp)
...
class AttentionLogger(tf.keras.callbacks.Callback):
    ...
    def greedy_decode_with_attention(self, encoder_input):
        ...
        for _ in range(self.max_length - 1):
            ...
            attention_step = attention_scores[0, len(
                decoder_input) - 1].numpy()
...
def main():
    ...
    with strategy.scope():
        ...
        model = build_seq2seq_model(
            ...
            encoder_units=train_config["encoder_units"],
            decoder_units=train_config["decoder_units"],
    ...
    tf.keras.utils.plot_model(
        model,
        to_file=f"attn_seq2seq_model_{args.dataset}.png",
        show_shapes=True,
        show_dtype=True,
